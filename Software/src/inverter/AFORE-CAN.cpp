...
void AforeCanInverter::
  ...
  AFORE_350.data.u8[0] = (datalayer.batteries[0].status.voltage_dV & 0x00FF);
  AFORE_350.data.u8[1] = (datalayer.batteries[0].status.voltage_dV >> 8);
  //Total battery current unit: 0.1A offset 5000; positive is charging,
  //Negative means discharge; for example: 1A = (5010-5000)/10
  AFORE_350.data.u8[2] = ((datalayer.batteries[0].status.reported_current_dA + 5000) & 0x00FF);
  AFORE_350.data.u8[3] = ((datalayer.batteries[0].status.reported_current_dA + 5000) >> 8);
  ...
  AFORE_350.data.u8[4] = ((datalayer.batteries[0].status.temperature_max_dC + 1000) & 0x00FF);
  AFORE_350.data.u8[5] = ((datalayer.batteries[0].status.temperature_max_dC + 1000) >> 8);

  /*0x351 -  Battery information*/
  AFORE_351.data.u8[0] = (datalayer.batteries[0].status.reported_soc / 100);  //Remove decimals, 0-100
  AFORE_351.data.u8[1] = (datalayer.batteries[0].status.soh_pptt / 100);      //Remove decimals, 0-100
  ...
  AFORE_351.data.u8[6] = (datalayer.batteries[0].info.number_of_cells & 0x00FF);
  AFORE_351.data.u8[7] = (datalayer.batteries[0].info.number_of_cells >> 8);

  /*0x352 - Protection parameters*/
  AFORE_352.data.u8[0] = (datalayer.batteries[0].status.max_charge_current_dA & 0x00FF);
  AFORE_352.data.u8[1] = (datalayer.batteries[0].status.max_charge_current_dA >> 8);
  AFORE_352.data.u8[2] = (datalayer.batteries[0].status.max_discharge_current_dA & 0x00FF);
  AFORE_352.data.u8[3] = (datalayer.batteries[0].status.max_discharge_current_dA >> 8);
  AFORE_352.data.u8[4] = (datalayer.batteries[0].info.max_design_voltage_dV & 0x00FF);
  AFORE_352.data.u8[5] = (datalayer.batteries[0].info.max_design_voltage_dV >> 8);
  AFORE_352.data.u8[6] = (datalayer.batteries[0].info.min_design_voltage_dV & 0x00FF);
  AFORE_352.data.u8[7] = (datalayer.batteries[0].info.min_design_voltage_dV >> 8);
  ...
  */
  ...
  AFORE_355.data.u8[0] = ((datalayer.batteries[0].status.temperature_max_dC + 1000) & 0x00FF);
  AFORE_355.data.u8[1] = ((datalayer.batteries[0].status.temperature_max_dC + 1000) >> 8);
  AFORE_355.data.u8[2] = ((datalayer.batteries[0].status.temperature_min_dC + 1000) & 0x00FF);
  AFORE_355.data.u8[3] = ((datalayer.batteries[0].status.temperature_min_dC + 1000) >> 8);
  ...
  AFORE_356.data.u8[0] = (datalayer.batteries[0].info.max_cell_voltage_mV & 0x00FF);
  AFORE_356.data.u8[1] = (datalayer.batteries[0].info.max_cell_voltage_mV >> 8);
  AFORE_356.data.u8[2] = (datalayer.batteries[0].info.min_cell_voltage_mV & 0x00FF);
  AFORE_356.data.u8[3] = (datalayer.batteries[0].info.min_cell_voltage_mV >> 8);
