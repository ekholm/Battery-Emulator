...
String NissanLeafHtmlRenderer::get_command_prefix_html(const char* identifier) {
  String content;
...
void NissanLeafHtmlRenderer::status_row(String& content, const char* label, uint8_t value, bool known,
                                        const char* name) {
  content += "<h4>";
  content += label;
  content += ": ";
...
void NissanLeafHtmlRenderer::new_panel(String& content, const char* title) {
