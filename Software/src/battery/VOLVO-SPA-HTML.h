...
class VolvoSpaHtmlRenderer : public BatteryHtmlRenderer {
 public:
  ...
  String get_status_html() {
    ...
    switch (data->HVILstatusBits & 0x02) {
      case 0x02:
        content += String("Open");
        break;
      default:
    ...
    switch (data->HVILstatusBits & 0x04) {
      case 0x04:
        content += String("Open");
        break;
      default:
    ...
    switch (data->HVILstatusBits & 0x08) {
      case 0x08:
        content += String("Open");
        break;
      default:
    ...
    switch (data->HVILstatusBits & 0x10) {
      case 0x10:
        content += String("Open");
        break;
      default:
    ...
    switch (data->HVILstatusBits & 0x20) {
      case 0x20:
        content += String("Open");
        break;
      default:
 ...
 private:
  DATALAYER_INFO_VOLVO_POLESTAR* data;
};
