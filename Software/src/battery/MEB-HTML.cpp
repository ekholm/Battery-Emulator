...
void MebHtmlRenderer::add_h4(String& out, const char* label, const char* value) {
  out += "<h4>";
  out += label;
  out += ": ";
  out += value;
...
void MebHtmlRenderer::add_h4(String& out, const char* label, const String& value) {
  out += "<h4>";
  out += label;
  out += ": ";
  out += value;
...
template <size_t N>
const char* MebHtmlRenderer::enum_str(const char* const (&table)[N], uint8_t value) {
