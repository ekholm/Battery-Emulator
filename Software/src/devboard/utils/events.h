...
#define EVENTS_ENUM_TYPE(XX)                 \
  ...
  XX(EVENT_CAN_NATIVE_INIT_FAILURE)          \
  XX(EVENT_CAN_NATIVE_NOT_INITIALIZED)       \
  XX(EVENT_CANMCP2515_NOT_INITIALIZED)       \
  XX(EVENT_CANFD_NOT_INITIALIZED)            \
  XX(EVENT_CANFD_2_NOT_INITIALIZED)          \
  XX(EVENT_CAN_INTERFACE_UNAVAILABLE)        \
  XX(EVENT_NOF_EVENTS)
