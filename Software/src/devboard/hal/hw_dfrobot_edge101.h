...
class DFRobotEdge101Hal : public Esp32Hal {
 public:
  ...
  // Ethernet (RMII PHY)
  gpio_num_t ETH_MDC_PIN() { return GPIO_NUM_4; }
  gpio_num_t ETH_MDIO_PIN() { return GPIO_NUM_13; }
  gpio_num_t ETH_POWER_PIN() { return GPIO_NUM_2; }
  uint8_t ETH_PHY_ADDR() { return 1; }
