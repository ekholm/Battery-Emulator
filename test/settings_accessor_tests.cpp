...
// Reverting the emulation's tag guards (065a50fd) passed the whole suite -
// the bool probe above cannot tell "tag honored, default returned" from "tag
// ignored, zero field returned" because WEBAUTH's default IS false. These
// rows' defaults are NOT the cross-typed zero, so a tag regression in either
// the emulation or the accessor's store-call choice fails here.
